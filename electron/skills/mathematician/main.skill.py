...
# 展示 .skill.py skill 写法：使用科学计算器工具包工具。
# 修改此文件即可客制化，保存后在界面点击"重载"生效。
# ============================================================
SKILL_ID = "mathematician"
SKILL_NAME = "Python 数学家"
SKILL_CATEGORY = "数学"
SKILL_DESC = "基于 Python 引擎的数学 skill，擅长表达式计算、解方程、求导、积分（配合科学计算器工具包）。"
SKILL_AVATAR = "🧮"
SKILL_MODEL = None  # 留空使用全局默认模型
SKILL_TEMPERATURE = 0.2
SKILL_MAX_TOKENS = 4096

# 工具：科学计算器工具包（tool:py_*），需要先启用了"科学计算器"工具包
SKILL_TOOLS = ['tool:py_eval', 'tool:py_solve', 'tool:py_derive', 'tool:py_integrate']
